...
from characters.Tumtum import Tumtum
...
class Fight:
    ...
    def create_characters(self, player1_name, player2_name):
        ...
        self.player1 = Tumtum(self, "player1", (pygame.K_w, pygame.K_a, pygame.K_s, pygame.K_d, pygame.K_q, pygame.K_e, pygame.K_r))
        self.character_bar1 = CharacterBar(self.player1, position(25, 15))
        self.player2 = Bombardiro(self, "player2", (pygame.K_i, pygame.K_j, pygame.K_k, pygame.K_l, pygame.K_u, pygame.K_o, pygame.K_p))
